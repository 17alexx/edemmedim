...
//1.
// const boyuuzunlar = users.filter(person => person.height > 150);

// console.log(boyuuzunlar);
...
// 3.
// const toplam = users.reduce((topla,person) => topla + person.age, 0);
// const orta = toplam / users.length;

// console.log(orta);



muellim qalanlarini eliye bilmirem normalda ederdim amma qeribediler aglim biraz catmir etmeye 